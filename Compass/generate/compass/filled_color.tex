...
\tikzset{
  ...
  magentashell/.style={draw=magenta,fill=magenta,fill opacity=1,  opacity=1},
  greenshell/.style={draw=green!50!black,fill=green!50!black, fill opacity=1,  opacity=1},
  blueshell/.style={draw=blue!70!black, fill=blue!70!black, fill opacity=1,opacity=1},
  orangeshell/.style={draw=orange!90!black, fill=orange!80,fill opacity=1, opacity=1},
  cyanshell/.style={draw=cyan!90!black, fill=cyan!80!black,fill opacity=1, opacity=1},
  brownshell/.style={draw=brown!90!black, fill=brown!80!black,fill opacity=1, opacity=1},
...
%   \fill (O) circle (0pt);% define coordinate for origin
  ...
  \draw [color=magenta,line width=1.5pt,opacity=1, fill=magenta!10, fill opacity=0.4] (D1-57) -- (D2-63) -- (D3-50) -- (D4-52) -- (D5-70) -- (D6-90) -- cycle;
  \draw [color=green!50!black,line width=1.5pt,opacity=1, fill=green!50!black!10, fill opacity=0.4] (D1-47) -- (D2-45) -- (D3-50) -- (D4-51) -- (D5-49) -- (D6-59) -- cycle;
  \draw [color=orange!90!black,line width=1.5pt,opacity=1, fill=orange!90!black!10, fill opacity=0.4] (D1-31) -- (D2-29) -- (D3-50) -- (D4-42) -- (D5-43) -- (D6-33) -- cycle;
  \draw [color=brown!90!black,line width=1.5pt,opacity=1, fill=brown!90!black!10, fill opacity=0.4] (D1-35) -- (D2-37) -- (D3-50) -- (D4-43) -- (D5-48) -- (D6-41) -- cycle;
  \draw [color=cyan!90!black,line width=1.5pt,opacity=1, fill=cyan!90!black!10, fill opacity=0.4] (D1-31) -- (D2-29) -- (D3-50) -- (D4-38) -- (D5-43) -- (D6-44) -- cycle;
  \draw [color=blue!70!black,line width=1.5pt,opacity=1, fill=blue!70!black!10, fill opacity=0.4] (D1-14) -- (D2-27) -- (D3-50) -- (D4-43) -- (D5-46) -- (D6-30) -- cycle;
...
%     % Entry for: A2C
  ...
  \pic at (0,0){strip={\Instrip,138.75,135.0,orangeshell, black, {}}};
