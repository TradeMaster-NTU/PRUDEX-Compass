...
\draw [color=orange,line width=1.5pt,opacity=0.6, fill=orange!90!black!10, fill opacity=0.4] (D1-31) -- (D2-29) -- (D3-50) -- (D4-42) -- (D5-43) -- (D6-33) -- cycle;

% \draw [color=green!50!black,line width=1.5pt,opacity=0.6, fill=green!50!black!10, fill opacity=0.4] (D1-31) -- (D2-29) -- (D3-50) -- (D4-42) -- (D5-43) -- (D6-33) -- cycle;
...
% \draw [color=orange,line width=1.5pt,opacity=0.6, fill=orange!10, fill opacity=0.4] (D1-47) -- (D2-45) -- (D3-50) -- (D4-51) -- (D5-49) -- (D6-59) -- cycle;
...
\draw [color=brown,line width=1.5pt,opacity=0.6, fill=brown!10, fill opacity=0.4] (D1-35) -- (D2-37) -- (D3-50) -- (D4-43) -- (D5-48) -- (D6-41) -- cycle;

-\draw [color=blue,line width=1.5pt,opacity=0.6, fill=blue!10, fill opacity=0.4] (D1-14) -- (D2-27) -- (D3-50) -- (D4-45) -- (D5-46) -- (D6-30) -- cycle;



    % Outer circle
    % Entry for: Method 1
\pic at (0,0){strip={\Instrip,0,3.75,orangeshell, black, {}}};
\pic at (0,0){strip={\Instrip,3.75,7.5,brownshell, black, {}}};
\pic at (0,0){strip={\Instrip,7.5,11.25,blueshell, black, {}}};
\pic at (0,0){strip={\Instrip,90,93.75,orangeshell, black, {}}};
\pic at (0,0){strip={\Instrip,93.75,97.5,brownshell, black, {}}};
\pic at (0,0){strip={\Instrip,97.5,101.25,blueshell, black, {}}};

\pic at (0,0){strip={\Instrip,138.75,135,orangeshell, black, {}}};
\pic at (0,0){strip={\Instrip,142.5,138.75,brownshell, black, {}}};
\pic at (0,0){strip={\Instrip,146.25,142.5,blueshell, black, {}}};

\pic at (0,0){strip={\Instrip,15,18.75,cyanshell, black, {}}};
\pic at (0,0){strip={\Instrip,82.5,86.25,cyanshell, black, {}}};
\pic at (0,0){strip={\Instrip,105,108.75,cyanshell, black, {}}};
\pic at (0,0){strip={\Instrip,150,153.75,cyanshell, black, {}}};
\pic at (0,0){strip={\Instrip,195,198.75,cyanshell, black, {}}};
...
\pic at (0,0){strip={\Instrip,191.25 , 195.0,greenshell, black, {}}};
...
\pic at (0,0){strip={\Instrip, 90.0 ,86.25 , magentashell, black, {}}};
...
\pic at (0,0){strip={\Instrip,198.75 , 202.5 , magentashell, black, {}}};
\pic at (0,0){strip={\Instrip,221.25 , 225.0 , magentashell, black, {}}};
\pic at (0,0){strip={\Instrip,243.75 , 247.5 , magentashell, black, {}}};
% \pic at (0,0){strip={\Instrip,266.25 , 270.0 , magentashell, black, {}}};
\pic at (0,0){strip={\Instrip, 270.0 ,266.25 , magentashell, black, {}}};

\pic at (0,0){strip={\Instrip,288.75 , 292.5 , magentashell, black, {}}};
\pic at (0,0){strip={\Instrip,311.25 , 315.0 , magentashell, black, {}}};
\pic at (0,0){strip={\Instrip,333.75 , 337.5 , magentashell, black, {}}};
% \pic at (0,0){strip={\Instrip,356.25 , 360.0 , magentashell, black, {}}};
\pic at (0,0){strip={\Instrip, 360.0 ,356.25 , magentashell, black, {}}};

t-SNE, rolling window, extreme market, performance profile, optimal gap, alpha decay, cross market, cross assets, entropy diversity, rank, profit criteria, risk criteria, statistical significance
...
\lentry{brown}{PPO}& 
\lentry{blue}{SAC}&
\lentry{green!50!black}{SARL} &
\lentry{cyan!90!black}{DeepTrader}&
\lentry{magenta}{AlphaMix+} \\
